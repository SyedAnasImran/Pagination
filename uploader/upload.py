# To run code use: python upload.py data_GulAhmed_2024-01-13.json add users-demo-add
...
class UploadJsonFileToFirestore:
    ...
    def set(self, item):
        return db.collection(self.collectionname).document(str(item['productID'])).set(item)
